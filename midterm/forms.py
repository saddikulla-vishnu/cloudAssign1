...
class UploadForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #  self.fields['hshds_file'].widget.attrs = {"class": "form-control"}
        self.fields['transactions_file'].widget.attrs = {"class": "form-control col-6"}
        #  self.fields['products_file'].widget.attrs = {"class": "form-control"}
    ...
    def save(self, *args, **kwargs):
        ...
        #  if hshds_file:
            ...
            #  __import__('pprint').pprint(hshd_data[:5])
        ...
        if transactions_file:
            ...
            #  __import__('pprint').pprint(transaction_data[:5])
            batch_size = 10000
        ...
        #  if products_file:
            ...
            #  __import__('pprint').pprint(product_data[:5])
